...
var appScaffoldKey = GlobalKey<ScaffoldMessengerState>();
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Listener(
      child: MaterialApp.router(
        ...
        title: 'Flutter Demo',
        routerConfig: ref.read(routerService),
        theme: ThemeData(
        ...
        builder: (context, widget) => MediaQuery(
          data: MediaQuery.of(context).copyWith(textScaler: const TextScaler.linear(1.23)),
          child: widget!,
        ),
      ),
    );
        ...
        child: Column(
          ...
          children: <Widget>[
            SizedBox(
              ...
              height: 200,
              child: Column(
                children: [Container(color: Colors.red, width: 200, height: _counter == 1 ? 205 : 200)],
              ),
            ),
            Text(tr('KEY')),
